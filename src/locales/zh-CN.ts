export default {
  ...
  store: {
    siderShopButton: '提示词商店',
    siderSettingButton: '提示词设定',
    local: '本地',
    online: '在线',
    title: '标题',
    description: '描述',
    ...
    addRepeatContentTips: '内容重复：，请重新输入',
    editRepeatTitleTips: '标题冲突，请重新修改',
    editRepeatContentTips: '内容冲突 ，请重新修改',
    importError: '键值不匹配',
    importRepeatTitle: '标题重复跳过：',
    importRepeatContent: '内容重复跳过：',
